...
Be direct, specific, and encouraging. Reference cues a real coach would use.`,
      ...
      setAnalysisResult({ ...analysis, video_url: file_url, isMockData: !import.meta.env.VITE_BASE44_ACCESS_TOKEN });
              ...
              {analysisResult.isMockData && (
                <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-3">
                  <p className="text-yellow-400 text-sm">
                    ⚠️ Demo Mode: This is sample analysis. Log in to Base44 for real AI form analysis.
                  </p>
                </div>
              )}
